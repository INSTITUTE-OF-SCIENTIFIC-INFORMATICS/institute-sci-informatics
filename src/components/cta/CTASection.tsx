  ...
  return (
    <section className="py-20 bg-institute-blue/10">
      <div className="container">
        <div className="bg-gradient-to-r from-institute-orange to-institute-red rounded-2xl p-10 text-white shadow-xl">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in animate-delay-200">
              <Button size="lg" className="bg-institute-yellow text-institute-red hover:bg-white/90">
                Enroll Now
              </Button>
