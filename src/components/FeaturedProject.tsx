...
const FeaturedProject = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-institute-indigo/10 to-institute-purple/10">
      <div className="container">
        <div className="flex flex-col md:flex-row gap-10 items-center">
          {/* Project Image */}
          <div className="md:w-1/2 animate-slide-in">
            <div className="relative">
              <div className="absolute -right-4 -bottom-4 w-full h-full rounded-xl border-2 border-primary/30 -z-10"></div>
              <img 
          ...
          <div className="md:w-1/2 animate-slide-in animate-delay-200">
            <h2 className="text-sm uppercase text-primary font-semibold tracking-wider mb-2">
              Open Source Project
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
              <div className="flex flex-col items-center bg-white p-4 rounded-lg shadow-sm">
                <GitBranch className="text-primary h-6 w-6 mb-2" />
              ...
              <div className="flex flex-col items-center bg-white p-4 rounded-lg shadow-sm">
                <Database className="text-primary h-6 w-6 mb-2" />
